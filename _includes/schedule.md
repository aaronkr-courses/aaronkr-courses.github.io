...
{% assign prev_date = lecture_date %}
  ...
  <tr class="{{ event_type }}">
    ...
    {% if lecture.skip or lecture.title contains 'Test' or lecture.title contains 'No Class' or forloop.last %}
    ...
    <td>
        ...
        {% endif %}
        {% if lecture.slides2 %}
        <a href="{{ lecture.slides2 }}" target="_blank">Slides 2{% if lecture.slides2Title %}: {{lecture.slides2Title}}{% endif %}</a>
        {% endif %}
    </td>
    <td>
